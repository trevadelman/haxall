...
#################################################################
# Number patches - REQUIRED bug fix for negative duration handling
#################################################################
...
#################################################################
# Pythonic interop patches (to_py, from_py, to_pandas, to_polars)
# ARCHIVED: 2026-01-23
# These patches have been moved to archive/pythonic-wrappers/
# per Rick and Brian's direction to focus on the transpiled API
# without additional wrapper layers.
#
# See archive/pythonic-wrappers/haystack_init_patches.py to restore.
#################################################################
